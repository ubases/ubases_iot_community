...
// FindInSetWithCol FIND_IN_SET(input_string, field_name)
func (field String) FindInSetWithCol(target String) Expr {
	return expr{e: clause.Expr{SQL: "FIND_IN_SET(?,?)", Vars: []interface{}{target.RawExpr(), field.RawExpr()}}}
}

func (field String) FindInSetWithInt16Col(target Int16) Expr {
	return expr{e: clause.Expr{SQL: "FIND_IN_SET(?,?)", Vars: []interface{}{target.RawExpr(), field.RawExpr()}}}
}

func (field String) FindInSetWithInt32Col(target Int32) Expr {
	return expr{e: clause.Expr{SQL: "FIND_IN_SET(?,?)", Vars: []interface{}{target.RawExpr(), field.RawExpr()}}}
}

func (field String) FindInSetWithInt64Col(target Int64) Expr {
	return expr{e: clause.Expr{SQL: "FIND_IN_SET(?,?)", Vars: []interface{}{target.RawExpr(), field.RawExpr()}}}
}
...
func (field String) GetVersionField() String {
	return String{expr{e: clause.Expr{SQL: "INET_ATON(CONCAT(?, '.0'))", Vars: []interface{}{field.RawExpr()}}}}
}

func GetVersionField(v string) String {
	return String{expr{e: clause.Expr{SQL: "INET_ATON(CONCAT(?, '.0'))", Vars: []interface{}{v}}}}
}
