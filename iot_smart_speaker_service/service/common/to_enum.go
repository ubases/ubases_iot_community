...
// axyVal 音响传入的数据
// 返回值：设备的值、音响的值、错误
func (s *ToEnum) AxyToVoiceConvert(devId string, adjust bool, dataType string, vpmap *protosService.OpmVoiceProductMap, axyVal interface{}) (interface{}, interface{}, error) {
	op := EnumToVoice{}
	switch dataType {
	case DT_ENUM:
...
// 枚举转枚举
// [{"val":0,"voiceValSynonym":"111"},{"val":1,"voiceValSynonym":"222"}]
func (EnumToVoice) enum2enum(vpmap *protosService.OpmVoiceProductMap, axyVal interface{}) (interface{}, interface{}, error) {
	var resData, resVData interface{}
	var voiceMap []map[string]interface{}
	err := json.Unmarshal([]byte(vpmap.ValueMap), &voiceMap)
	if err != nil {
...
// 枚举转数值
// [{"val":0,"voiceValSynonym":"","vMin":1,"vMax":8,"vStep":1},{"val":1,"voiceValSynonym":"","vMin":9,"vMax":100,"vStep":1}]
func (EnumToVoice) enum2float(devId string, adjust bool, vpmap *protosService.OpmVoiceProductMap, axyVal interface{}) (interface{}, interface{}, error) {
	var voiceMap []map[string]interface{}
	err := json.Unmarshal([]byte(vpmap.ValueMap), &voiceMap)
	if err != nil {
		return nil, nil, err
