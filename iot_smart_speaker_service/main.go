...
import (
	...
	"cloud_platform/iot_smart_speaker_service/rpc/rpcserver"
...
var (
	...
	name           = "iot_smart_speaker_service"
)
...
func main() {
	...
	t, io, err := iottrace.NewZipkinTracer("bat.iot.app.api.service", serviceCfg.HttpAddr, config.Global.Zipkin.Url)
	if err != nil {
