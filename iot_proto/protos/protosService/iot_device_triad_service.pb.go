...
var file_iot_device_triad_service_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x32, 0xbb, 0x0f, 0x0a, 0x15, 0x49, 0x6f, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63,
	...
	0x6f, 0x72, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x93, 0x01, 0x0a, 0x13,
	0x47, 0x65, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x72, 0x69, 0x61, 0x64, 0x43, 0x6f,
	0x75, 0x6e, 0x74, 0x12, 0x23, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x49, 0x6f,
	...
	0x63, 0x65, 0x2e, 0x49, 0x6f, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x72, 0x69, 0x61,
	0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x31,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2b, 0x22, 0x26, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6f, 0x74, 0x44,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x72, 0x69, 0x61, 0x64, 0x2f, 0x67, 0x65, 0x74, 0x44, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x54, 0x72, 0x69, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x01,
...
var file_iot_device_triad_service_proto_goTypes = []interface{}{
	...
	(*IotDeviceTriadCountRequest)(nil),        // 8: service.IotDeviceTriadCountRequest
	(*Response)(nil),                          // 9: service.Response
	(*IotDeviceTriadResponse)(nil),            // 10: service.IotDeviceTriadResponse
	(*IotDeviceTriadCountResponse)(nil),       // 11: service.IotDeviceTriadCountResponse
}
var file_iot_device_triad_service_proto_depIdxs = []int32{
	...
	8,  // 16: service.IotDeviceTriadService.GetDeviceTriadCount:input_type -> service.IotDeviceTriadCountRequest
	9,  // 17: service.IotDeviceTriadService.Create:output_type -> service.Response
	9,  // 18: service.IotDeviceTriadService.Delete:output_type -> service.Response
	9,  // 19: service.IotDeviceTriadService.DeleteById:output_type -> service.Response
	9,  // 20: service.IotDeviceTriadService.DeleteByIds:output_type -> service.Response
	9,  // 21: service.IotDeviceTriadService.Update:output_type -> service.Response
	9,  // 22: service.IotDeviceTriadService.UpdateAll:output_type -> service.Response
	9,  // 23: service.IotDeviceTriadService.UpdateFields:output_type -> service.Response
	10, // 24: service.IotDeviceTriadService.FindById:output_type -> service.IotDeviceTriadResponse
	10, // 25: service.IotDeviceTriadService.Find:output_type -> service.IotDeviceTriadResponse
	10, // 26: service.IotDeviceTriadService.Lists:output_type -> service.IotDeviceTriadResponse
	9,  // 27: service.IotDeviceTriadService.GeneratorDeviceTriad:output_type -> service.Response
	9,  // 28: service.IotDeviceTriadService.GetDeviceTriadCountByTenantId:output_type -> service.Response
	9,  // 29: service.IotDeviceTriadService.SetTestDeviceTriad:output_type -> service.Response
	9,  // 30: service.IotDeviceTriadService.BindTestAccount:output_type -> service.Response
	9,  // 31: service.IotDeviceTriadService.CreateAndBindDeviceTriad:output_type -> service.Response
	10, // 32: service.IotDeviceTriadService.SetExportCount:output_type -> service.IotDeviceTriadResponse
	11, // 33: service.IotDeviceTriadService.GetDeviceTriadCount:output_type -> service.IotDeviceTriadCountResponse
