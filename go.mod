...
require (
	github.com/ArtisanCloud/PowerWeChat/v3 v3.2.9
	...
	github.com/asim/go-micro/plugins/wrapper/ratelimiter/uber/v4 v4.7.0
	github.com/asim/go-micro/plugins/wrapper/select/roundrobin/v4 v4.7.0
