...
func RegisterRouter(e *gin.Engine) {
	...
	admin.GET("/pm/product/getFaultType", apis.Productcontroller.GetFaultType)
	...
	admin.POST("/product/module/selectFirmwareVersion", apis.Modulecontroller.SelectFirmwareVersions)
