...
type Settings struct {
	...
	AppJwt          JWTConfig              `yaml:"appjwt"`             //JWT配置
...
func Init() error {
	...
	configFile = "./conf/" + env + "/iot_app_user_service.yml"
...
func Init2() error {
	...
	conf, err := iotconfig.NewNacosConfig(&cnf.Nacos, fmt.Sprintf("iot_app_user_service-%s.yaml", cnf.Config.Env))
	if err != nil {
		return err
	}
