...
// 初始化casbin
func InitCasbin(mysqlConnect string, casbinConfPath string) error {

	a, _ := gormadapter.NewAdapter("mysql", mysqlConnect, "iot_system", "t_sys_casbin_rule", true) // Your driver and data source.
