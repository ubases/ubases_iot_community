...
func newTOpenUser(db *gorm.DB) tOpenUser {
	...
	_tOpenUser.CompanyId = field.NewInt64(tableName, "company_id")
	...
	_tOpenUser.DeptId = field.NewInt64(tableName, "dept_id")
	_tOpenUser.Remark = field.NewString(tableName, "remark")
	_tOpenUser.IsAdmin = field.NewInt32(tableName, "is_admin")
	_tOpenUser.Address = field.NewString(tableName, "address")
	_tOpenUser.Describe = field.NewString(tableName, "describe")
	_tOpenUser.PhoneNum = field.NewString(tableName, "phone_num")
