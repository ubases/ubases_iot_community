...
const TableNameTOpenCasbinRule = "t_open_casbin_rule"

// TOpenCasbinRule mapped from table <t_open_casbin_rule>
...
// TableName TOpenCasbinRule's table name
func (*TOpenCasbinRule) TableName() string {
	return TableNameTOpenCasbinRule
}
